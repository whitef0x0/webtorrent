...
var smsClient = new twilio.RestClient('AC408a347974a499a0df184df3501cbfc6', '0930692ce48a7d150e72354fb64c9097')
...
function Torrent (torrentId, opts) {
  ...
  self.client.smsNumber = '+' + self.client.smsNumber
...
Torrent.prototype._onStore = function () {
  ...
  var smsBody = 'download started'
  if (self.resumed) {
    self.resumed = false
    smsBody = 'download resumed'
  }

  if (self.client.smsNumber) {
    var resp, err
    var twilio = require('twilio')
    var smsClient =  require('twilio')('AC408a347974a499a0df184df3501cbfc6', '0930692ce48a7d150e72354fb64c9097')

    smsClient.sendMessage({
      to: self.client.smsNumber,
      from: '+15873336376',
      body: 'hello'
...
Torrent.prototype.pause = function (cb) {
  ...
  console.log(self.client.smsNumber)
